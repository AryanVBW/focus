...
const AboutSection = () => {
    ...
    return (_jsx("section", { id: "about", className: "section bg-white", children: _jsxs("div", { className: "container-custom", children: [_jsxs("div", { className: "section-title", children: [_jsx(motion.h2, { initial: { opacity: 0, y: 20 }, whileInView: { opacity: 1, y: 0 }, viewport: { once: true, margin: "-100px" }, transition: { duration: 0.6 }, children: "What is Focus?" }), _jsx(motion.p, { initial: { opacity: 0, y: 20 }, whileInView: { opacity: 1, y: 0 }, viewport: { once: true, margin: "-100px" }, transition: { duration: 0.6, delay: 0.1 }, children: "A powerful tool to help you break free from digital distractions" })] }), _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-12 items-center", children: [_jsx(motion.div, { initial: { opacity: 0, x: -30 }, whileInView: { opacity: 1, x: 0 }, viewport: { once: true, margin: "-100px" }, transition: { duration: 0.6 }, children: _jsxs("div", { className: "aspect-square max-w-md mx-auto relative", children: [_jsx("div", { className: "absolute inset-0 bg-gradient-to-br from-primary-100 to-primary-50 rounded-full" }), _jsxs("div", { className: "absolute inset-0 flex items-center justify-center", children: [
                                ...
                                ]})] }) }), _jsxs(motion.div, { initial: { opacity: 0, x: 30 }, whileInView: { opacity: 1, x: 0 }, viewport: { once: true, margin: "-100px" }, transition: { duration: 0.6, delay: 0.2 }, children: [_jsx("h3", { className: "text-2xl font-semibold mb-4 text-gray-900 dark:text-gray-100", children: "Digital Wellness, Reimagined" }), _jsx("p", { className: "text-gray-600 dark:text-gray-300 mb-6", children: "Focus is an Android app designed to help you regain control of your digital life. In a world of constant notifications and endless scrolling, Focus helps you establish healthier technology habits." }), _jsx("p", { className: "text-gray-600 dark:text-gray-300 mb-6", children: "Our app intelligently blocks distracting content, filters out adult material, and gives you control over which apps can interrupt your focus time. It's not about completely disconnecting\u2014it's about creating a healthier relationship with technology." }), _jsxs("div", { className: "flex flex-col gap-4", children: [_jsxs("div", { className: "flex items-center gap-3", children: [_jsx("span", { className: "w-2 h-2 bg-primary-500 rounded-full" }), _jsx("p", { className: "text-gray-700 dark:text-gray-300", children: "Monitor and understand your digital habits" })] }), _jsxs("div", { className: "flex items-center gap-3", children: [_jsx("span", { className: "w-2 h-2 bg-primary-500 rounded-full" }), _jsx("p", { className: "text-gray-700 dark:text-gray-300", children: "Block distractions during important work" })] }), _jsxs("div", { className: "flex items-center gap-3", children: [_jsx("span", { className: "w-2 h-2 bg-primary-500 rounded-full" }), _jsx("p", { className: "text-gray-700 dark:text-gray-300", children: "Create healthier digital boundaries" })] })] })] })] })] }) }));
};
